            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <table class="table table-bordered table-striped table-hover" id="mytable">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <a class="btn btn-warning" title="Show" href="{{URL::to('user/view/order/'.$row->id)}}"><i class="fa fa-eye"></i></a>
                                            </td>
                                          </tr>
                                          @endforeach
                                        </tbody>
                        ...
                        <div class="col-2">
                            <div class="card">
                                <img class="card-img-top" src="{{ asset('public/user_design/image/profile.png') }}" alt="Card image cap">
                                <div class="card-header bg-secondary">
                                  <h3 class="card-title text-white ">{{ Auth::user()->name }}</h3>
                                </div>
                                <div class="card-body">
                                    <a href="{{ route('user.checkout') }}" class="btn  btn-success btn-block">Profile</a>
                                    <a href="{{ route('change.password.form') }}" class="btn  btn-warning btn-block">Change Password</a>
