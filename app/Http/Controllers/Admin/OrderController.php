...
class OrderController extends Controller
{
    ...
    public function AcceptPaymentOrder(){
    	...
    	return view('admin.order.accept_payment',compact('order')) ;
    }
    ...
    public function ProgressPaymentOrder(){
    	...
    	return view('admin.order.process_delivery',compact('order')) ;
    }
    ...
    public function SuccessPaymentOrder(){
    	...
    	return view('admin.order.delivery_success',compact('order')) ;
    }
